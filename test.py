...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("DDXL", SCREEN_WIDTH/2, SCREEN_HEIGHT/2,
                         arcade.color.BLACK, font_size=50, anchor_x="center")
        arcade.draw_text("Click to advance", SCREEN_WIDTH/2, SCREEN_HEIGHT/2-75,
                         arcade.color.GRAY, font_size=20, anchor_x="center")

    def on_mouse_press(self, _x, _y, _button, _modifiers):
        instructions_view = DDXL(SCREEN_WIDTH, SCREEN_HEIGHT, SCREEN_TITLE)
...
class DDXL(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text(output, 450, 200, arcade.color.ARSENIC, 200, 300, 'center', 'Calibri')
